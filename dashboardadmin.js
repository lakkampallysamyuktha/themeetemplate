// dashboardadmin.js — Orange / Black / White Theme
...
(function() {
  ...
  const siteData = [
    { name: 'US-East DC', pct: 99 },
    { name: 'EU-West DC', pct: 98 },
    { name: 'US-West DC', pct: 99 },
    { name: 'AP-South DC', pct: 98 },
    { name: 'EU-Central DC', pct: 88 }
  ];
  ...
  function drawBigChart() {
    ...
    grad.addColorStop(1, 'rgba(255, 87, 34, 0.02)');
  ...
  // ── Logs ──
  const logMessages = [
    { level: 'ok', msg: 'US-East DC: Database migration completed successfully' },
    { level: 'info', msg: 'User elena@stackly.org signed in from 103.x.x.x' },
    { level: 'warn', msg: 'US-West DC: High memory usage on cache cluster' },
    { level: 'ok', msg: 'Daily backup completed — 240 GB archived' },
    { level: 'info', msg: 'API call: GET /v1/nodes/all — 200 OK' },
    { level: 'ok', msg: 'EU-West DC: SSL certificates renewed' },
    { level: 'warn', msg: 'EU-Central DC: Storage capacity warning' }
  ];
